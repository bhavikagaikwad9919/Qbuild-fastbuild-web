...
import { downloadBillRegisterExcelReport } from "app/main/projects/store/projectsSlice";
...
const BillRegsiterDialog = (props) => {
  ...
  const [bill_registerdateformat, setBillRegisterDateFormat] = useState("");
  ...
  const bill_registerformatting = (value) => {
    setBillRegisterDateFormat(value)
  }
  ...
  const disableButton = () => {
    return (
        bill_registerdateformat.length > 0
  ...
  const handleSubmit = () => {
    ...
    if (bill_registerdateformat === "") {
      ...
      if (bill_registerdateformat === "Last Month") {
        var date = new Date();
        ...
        <AppBar className={classes.appBar}>
          <Toolbar>
            <div className="flex flex-1 items-center justify-between">
              <Typography>Download Bill Register Report</Typography>
            ...
            <div className="mt-10 mb-16 w-full">
               <FormControl fullWidth variant="outlined">
                 <InputLabel id="demo-simple-select-outlined-label">
                  ...
                  <Select
                     id="date format"
                     value={bill_registerdateformat}
                     label="Select Period"
                  >
                     <MenuItem value="Since Inception" onClick={() => bill_registerformatting("Since Inception")}>Since Inception</MenuItem>
                     <MenuItem value="Last Month" onClick={() => bill_registerformatting("Last Month")}>Last Month</MenuItem>
                     <MenuItem value="Custom" onClick={() => bill_registerformatting("Custom")}>Custom</MenuItem>
                  </Select>
                </FormControl>
            </div>
            {bill_registerdateformat === "Custom" ? (
              <>
...
export default React.memo(BillRegsiterDialog);
