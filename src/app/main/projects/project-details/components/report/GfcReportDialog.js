...
import { downloadGfcExcelReport } from "app/main/projects/store/projectsSlice";
...
const GfcReportDialog = (props) => {
  ...
  const [gfcdateformat, setGfcDateFormat] = useState("");
  ...
  const gfcformatting = (value) => {
    setGfcDateFormat(value)
  }
        ...
        <AppBar className={classes.appBar}>
          <Toolbar>
            <div className="flex flex-1 items-center justify-between">
              <Typography>Download GFC Workflow Report</Typography>
        ...
        <DialogContent>
          ...
          <FormControl fullWidth variant="outlined">
            ...
            <Select
              ...
              label="Select Period"
            >
              <MenuItem value="Since Inception" onClick={() => gfcformatting("Since Inception")}>Since Inception</MenuItem>
              <MenuItem value="Last Month" onClick={() => gfcformatting("Last Month")}>Last Month</MenuItem>
              <MenuItem value="Custom" onClick={() => gfcformatting("Custom")}>Custom</MenuItem>
            </Select>
          </FormControl>
          </div>
         {gfcdateformat === "Custom" ? (
          <>
...
export default React.memo(GfcReportDialog);
