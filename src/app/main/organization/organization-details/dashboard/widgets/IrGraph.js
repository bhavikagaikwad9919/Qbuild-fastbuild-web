...
function IrGraph(props) {
	...
	return (
		<>
			<Typography className= "font-bold mt-10 text-center cursor-pointer" onClick={()=> setOpen(true)}> Inspection Request (IR) </Typography>
			<Doughnut
			...
			<Dialog fullWidth open={open}>
              <DialogTitle id="alert-dialog-title">Inspection Request (IR) </DialogTitle> 
...
export default React.memo(IrGraph);
