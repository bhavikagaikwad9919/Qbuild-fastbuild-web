...
function RfiGraph(props) {
		...
		},
		{
			beforeDraw: function(chart) {
			 var width = chart.width,
				 ...
				 ctx.font = fontSize + "em roboto-bold";
	...
	return (
		<div>
			<Typography className="font-bold mt-10 ml-0 text-center cursor-pointer" onClick={()=> setOpen(true)}> Request for Information (RFI) </Typography>
			<Doughnut
				data={data}
				plugins={plugins}
				options={options}
			...
			<Dialog fullWidth open={open}>
              <DialogTitle id="alert-dialog-title"> Request for Information (RFI) </DialogTitle> 
...
export default React.memo(RfiGraph);
