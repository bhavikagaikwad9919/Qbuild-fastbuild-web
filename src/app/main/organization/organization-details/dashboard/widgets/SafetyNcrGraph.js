...
function SafetyNcrGraph(props) {
	...
	return (
		<>
			<Typography className= "font-bold mt-10 text-center cursor-pointer" onClick={()=> setOpen(true)}> Safety NCR </Typography>
			<Doughnut
				data={data}
				plugins={plugins}
				options={options}
			...
			<Dialog fullWidth open={open}>
              <DialogTitle id="alert-dialog-title"> Safety NCR </DialogTitle> 
			...
			<Dialog fullWidth maxWidth='md' open={show}>
                <DialogTitle id="alert-dialog-title">
			        <Grid container className={'mt-10'}>
				        <Grid xs={6} >
					      <Typography  className="font-bold text-left ml-10">{type} - Safety NCR - {ncrData.length}</Typography>
				        </Grid>
				        <Grid xs={5}>
...
export default React.memo(SafetyNcrGraph);
